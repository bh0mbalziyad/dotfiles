...
-- Enable mousemoveevents for bufferline
...
vim.keymap.set('n', '<C-w><', ':vertical resize -5<CR>') -- Decrease width
vim.keymap.set('n', '<C-w>>', ':vertical resize +5<CR>') -- Increase width
vim.keymap.set('n', '<C-w>-', ':resize -5<CR>') -- Decrease height
vim.keymap.set('n', '<C-w>+', ':resize +5<CR>') -- Increase height
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Shortcut for showing lsp diagnostics in the current buffer
      ...
      -- Autocommand to modify the preview buffer used by Telescope
      vim.api.nvim_create_autocmd('User', {
        pattern = 'TelescopePreviewerLoaded',
        callback = function()
          vim.wo.wrap = true -- Set the wrap option locally for the window
        end,
      })
    end,
  },
